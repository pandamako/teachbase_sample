...
Rails.application.config.sorcery.configure do |config|
  ...
  config.external_providers = [:teachbase]
  ...
  config.teachbase.key = Rails.application.secrets.oauth[:teachbase][:key]
  config.teachbase.secret = Rails.application.secrets.oauth[:teachbase][:secret]
  ...
  config.teachbase.site = Rails.application.secrets.oauth[:teachbase][:site]
  #
  # config.twitter.key = ""
